...
@Component({
  ...
  imports: [HeroComponent, ChooseSystemComponent, HowItWorkComponent, IndustriesComponent, FAQComponent, LandingPageFooterComponent, LandingpageNavComponent, LandingpageRegisterComponent]
})
